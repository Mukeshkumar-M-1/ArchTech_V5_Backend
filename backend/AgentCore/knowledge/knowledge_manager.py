...
class KnowledgeGraph:
    ...
    def add_edge(self, source: str, target: str, relationship: str, confidence: float, obs_id: str) -> None:
        ...
        log.info(f"[KnowledgeGraph] Added edge: {source} -[{relationship}]-> {target} (Conf: {confidence})")
...
class KnowledgeUpdater:
    ...
    def process_observation(self, observation: ObservationManager, relationships: List[Dict[str, str]]) -> None:
        """
