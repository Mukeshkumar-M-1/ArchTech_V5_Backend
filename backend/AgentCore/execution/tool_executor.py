...
class ToolExecutor:
    ...
    def __init__(self, permission_checker: PermissionManager | None = None, model_map: dict[str, Any] | None = None):
        """Initialize the tool executor with optional permission checking and model map.

        Args:
            permission_checker: Optional PermissionManager instance.
